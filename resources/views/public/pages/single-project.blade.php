...
@section('content')
  ...
  <div class="top-bar">
    <h1>project title</h1>
    <p><a href="{{url('/')}}">Home</a> / <a href="{{url('/portfolio')}}">portfolio</a> / project title</p>
  </div>
  <!-- end top-bar -->
  ...
  <div class="container main-container">
    <div class="col-md-12">
      <img src="{{asset('image/public/portfolio/portfolio.jpg')}}" alt="" class="img-responsive"/>
      <div class="h-30"></div>
    </div>
    ...
    <div class="col-md-9">
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliter enim nosmet ipsos nosse non possumus. Inscite
        ...
        voluptatis aditus ultimum cum ultimo sapientiae Et nemo nimium beatus est </p>
